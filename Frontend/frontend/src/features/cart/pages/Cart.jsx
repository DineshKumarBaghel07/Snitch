...
const Cart = () => {
    ...
    const getDisplayImage = (product, variant) => {
        ...
        if (variant[0]?.images?.length) return variant[0]?.images[ 0 ]?.url
        console.log(product?.variants[0]?.images?.length);
        if (product?.variants[0]?.images?.length) return product?.variants[0]?.images[ 0 ].url
        return null
    }
                        ...
                        <div className="w-full lg:w-[65%]">
                            ...
                            <div className="flex flex-col gap-6">
                                {cart.items.map(item => {
                                    ...
                                    console.log("variantdetails",variantDetail)
